...
public class AuthorityReportInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private DatabaseReference authorityAppReportDatabaseRef;
    private FirebaseUser mUser;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_authority_report_info);
        ...
        reportTimeTextView = findViewById(R.id.auth_report_time_textview);
        reportTitleTextView = findViewById(R.id.auth_report_title_textview);
        reportInfoTextView = findViewById(R.id.auth_report_information_textview);
        reportAppNameTextView = findViewById(R.id.auth_report_appName_textview);
        reportConfTextView = findViewById(R.id.auth_report_phoneConf_textview);
        reportUserContactTextView = findViewById(R.id.auth_report_contact_textView);
        copyAllReportInfoTextView = findViewById(R.id.copy_auth_report_info_textview);
        ...
        final String DATABASE_PATH = "transport_authority_app" + "/" + "report_feedback" + "/" + reportId;
        authorityAppReportDatabaseRef = FirebaseDatabase.getInstance().getReference(DATABASE_PATH);
    ...
    public void addDataInField() {
        authorityAppReportDatabaseRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                try {
                    ...
                    reportUserContactTextView.setText(email);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AuthorityReportInfoActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onClick(View v) {
        ...
        if (v == copyAllReportInfoTextView) {
            ...
            Toast.makeText(AuthorityReportInfoActivity.this, "Report information copied", Toast.LENGTH_LONG).show();
