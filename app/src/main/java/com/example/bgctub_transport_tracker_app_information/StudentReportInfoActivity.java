...
public class StudentReportInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private DatabaseReference studentAppReportDatabaseRef;
    private FirebaseUser mUser;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_student_report_info);
        ...
        reportTimeTextView = findViewById(R.id.stu_report_time_textview);
        reportTitleTextView = findViewById(R.id.stu_report_title_textview);
        reportInfoTextView = findViewById(R.id.stu_report_information_textview);
        reportAppNameTextView = findViewById(R.id.stu_report_appName_textview);
        reportConfTextView = findViewById(R.id.stu_report_phoneConf_textview);
        reportUserContactTextView = findViewById(R.id.stu_report_contact_textView);
        copyAllReportInfoTextView = findViewById(R.id.copy_stu_report_info_textview);
        ...
        final String DATABASE_PATH = "student_app" + "/" + "report_feedback" + "/" + reportId;
        studentAppReportDatabaseRef = FirebaseDatabase.getInstance().getReference(DATABASE_PATH);
    ...
    public void addDataInField() {
        studentAppReportDatabaseRef.addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(StudentReportInfoActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onClick(View v) {
        ...
        if (v == copyAllReportInfoTextView) {
            ...
            Toast.makeText(StudentReportInfoActivity.this, "Report information copied", Toast.LENGTH_LONG).show();
